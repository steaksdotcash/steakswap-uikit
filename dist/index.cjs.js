...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#261d13", invertedContrast: "#FFFFFF", input: "#f4efea", tertiary: "#EFF4F5", text: "#f98c08", textDisabled: "#BDC2C4", textSubtle: "#444", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#261e13", input: "#5a4d3f", primaryDark: "#ffb948", tertiary: "#473e35", text: "#fff", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#2c2926", gradients: {
